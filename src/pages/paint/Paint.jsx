...
const DrawingComponent = () => {
  ...
  const [shape, setShape] = useState('line'); // 'line' or 'rectangle'
...
const drawShape = () => {
  ...
  return (
    <div>
      <div className='flex gap-5 justify-center py-10' style={{ marginBottom: '10px' }}>
        <input
          type="color"
          value={drawingColor}
        ...
        <button onClick={() => { setShape('erase') }}>Erase</button>
